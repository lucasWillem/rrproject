...
const useFetchAllCountries = (limit: number): UseQueryResult<BasicCountry[], FetchError> & { isLoading: boolean } =>
     useQuery<BasicCountry[], FetchError>('countries', () => fetchAllCountries(limit));
